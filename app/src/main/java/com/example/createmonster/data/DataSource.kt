...
object DataSource {
    val tabs = listOf(
        ...
        //TabInfo("Body", R.drawable.ico_body, R.drawable.ico_body_selected, 37),
    )
    ...
    private val mouths = listOf(
        ...
        Pair(R.drawable.btn_mouth_09, R.drawable.mouth_11),
        Pair(R.drawable.btn_mouth_10, R.drawable.mouth_09),
        Pair(R.drawable.btn_mouth_11, R.drawable.mouth_10),
    ...
    val allParts = listOf(heads, eyes, mouths, accs)
}