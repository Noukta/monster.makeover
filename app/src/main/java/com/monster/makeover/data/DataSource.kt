...
object DataSource {
    ...
    private val heads = listOf(
        ...
        Pair(R.drawable.btn_head_36, R.drawable.head_36),
        Pair(R.drawable.btn_head_37, R.drawable.head_37),
        Pair(R.drawable.btn_head_38, R.drawable.head_38),
        Pair(R.drawable.btn_head_39, R.drawable.head_39),
        Pair(R.drawable.btn_head_40, R.drawable.head_40),
        Pair(R.drawable.btn_head_41, R.drawable.head_41),
        Pair(R.drawable.btn_head_42, R.drawable.head_42),
        Pair(R.drawable.btn_head_43, R.drawable.head_43),
        Pair(R.drawable.btn_head_44, R.drawable.head_44),
        Pair(R.drawable.btn_head_45, R.drawable.head_45),
        Pair(R.drawable.btn_head_46, R.drawable.head_46),
        Pair(R.drawable.btn_head_47, R.drawable.head_47),
        Pair(R.drawable.btn_head_48, R.drawable.head_48),
        Pair(R.drawable.btn_head_49, R.drawable.head_49),
        Pair(R.drawable.btn_head_50, R.drawable.head_50),
        Pair(R.drawable.btn_head_51, R.drawable.head_51),
        Pair(R.drawable.btn_head_52, R.drawable.head_52),
        Pair(R.drawable.btn_head_53, R.drawable.head_53),
        Pair(R.drawable.btn_head_54, R.drawable.head_54),
        Pair(R.drawable.btn_head_55, R.drawable.head_55)
    )
    private val eyes = listOf(
        ...
        Pair(R.drawable.btn_eye_63, R.drawable.eye_63),
        Pair(R.drawable.btn_eye_64, R.drawable.eye_64),
        Pair(R.drawable.btn_eye_65, R.drawable.eye_65),
        Pair(R.drawable.btn_eye_66, R.drawable.eye_66),
        Pair(R.drawable.btn_eye_67, R.drawable.eye_67),
        Pair(R.drawable.btn_eye_68, R.drawable.eye_68),
        Pair(R.drawable.btn_eye_69, R.drawable.eye_69),
        Pair(R.drawable.btn_eye_70, R.drawable.eye_70),
        Pair(R.drawable.btn_eye_71, R.drawable.eye_71),
        Pair(R.drawable.btn_eye_72, R.drawable.eye_72),
        Pair(R.drawable.btn_eye_73, R.drawable.eye_73),
        Pair(R.drawable.btn_eye_74, R.drawable.eye_74),
        Pair(R.drawable.btn_eye_75, R.drawable.eye_75),
        Pair(R.drawable.btn_eye_76, R.drawable.eye_76),
        Pair(R.drawable.btn_eye_77, R.drawable.eye_77),
        Pair(R.drawable.btn_eye_78, R.drawable.eye_78),
        Pair(R.drawable.btn_eye_79, R.drawable.eye_79),
        Pair(R.drawable.btn_eye_80, R.drawable.eye_80),
        Pair(R.drawable.btn_eye_81, R.drawable.eye_81),
        Pair(R.drawable.btn_eye_82, R.drawable.eye_82),
        Pair(R.drawable.btn_eye_83, R.drawable.eye_83),
        Pair(R.drawable.btn_eye_84, R.drawable.eye_84),
        Pair(R.drawable.btn_eye_85, R.drawable.eye_85),
        Pair(R.drawable.btn_eye_86, R.drawable.eye_86),
        Pair(R.drawable.btn_eye_87, R.drawable.eye_87),
        Pair(R.drawable.btn_eye_88, R.drawable.eye_88),
        Pair(R.drawable.btn_eye_89, R.drawable.eye_89),
        Pair(R.drawable.btn_eye_90, R.drawable.eye_90),
        Pair(R.drawable.btn_eye_91, R.drawable.eye_91),
        Pair(R.drawable.btn_eye_92, R.drawable.eye_92),
        Pair(R.drawable.btn_eye_93, R.drawable.eye_93),
        Pair(R.drawable.btn_eye_94, R.drawable.eye_94),
        Pair(R.drawable.btn_eye_95, R.drawable.eye_95)
    )
    private val mouths = listOf(
        ...
        Pair(R.drawable.btn_mouth_35, R.drawable.mouth_35),
        Pair(R.drawable.btn_mouth_36, R.drawable.mouth_36),
        Pair(R.drawable.btn_mouth_37, R.drawable.mouth_37),
        Pair(R.drawable.btn_mouth_38, R.drawable.mouth_38),
        Pair(R.drawable.btn_mouth_39, R.drawable.mouth_39),
        Pair(R.drawable.btn_mouth_40, R.drawable.mouth_40),
        Pair(R.drawable.btn_mouth_41, R.drawable.mouth_41),
        Pair(R.drawable.btn_mouth_42, R.drawable.mouth_42),
        Pair(R.drawable.btn_mouth_43, R.drawable.mouth_43),
        Pair(R.drawable.btn_mouth_44, R.drawable.mouth_44),
        Pair(R.drawable.btn_mouth_45, R.drawable.mouth_45),
        Pair(R.drawable.btn_mouth_46, R.drawable.mouth_46),
        Pair(R.drawable.btn_mouth_47, R.drawable.mouth_47),
        Pair(R.drawable.btn_mouth_48, R.drawable.mouth_48),
        Pair(R.drawable.btn_mouth_49, R.drawable.mouth_49),
        Pair(R.drawable.btn_mouth_50, R.drawable.mouth_50),
        Pair(R.drawable.btn_mouth_51, R.drawable.mouth_51),
        Pair(R.drawable.btn_mouth_52, R.drawable.mouth_52),
        Pair(R.drawable.btn_mouth_53, R.drawable.mouth_53),
        Pair(R.drawable.btn_mouth_54, R.drawable.mouth_54),
        Pair(R.drawable.btn_mouth_55, R.drawable.mouth_55),
        Pair(R.drawable.btn_mouth_56, R.drawable.mouth_56),
        Pair(R.drawable.btn_mouth_57, R.drawable.mouth_57),
        Pair(R.drawable.btn_mouth_58, R.drawable.mouth_58),
        Pair(R.drawable.btn_mouth_59, R.drawable.mouth_59)
    )
    ...
    private val bodies = listOf(
        ...
        Pair(R.drawable.btn_body_37, R.drawable.body_37),
        Pair(R.drawable.btn_body_38, R.drawable.body_38),
        Pair(R.drawable.btn_body_39, R.drawable.body_39),
        Pair(R.drawable.btn_body_40, R.drawable.body_40),
        Pair(R.drawable.btn_body_41, R.drawable.body_41),
        Pair(R.drawable.btn_body_42, R.drawable.body_42),
        Pair(R.drawable.btn_body_43, R.drawable.body_43),
        Pair(R.drawable.btn_body_44, R.drawable.body_44),
        Pair(R.drawable.btn_body_45, R.drawable.body_45),
        Pair(R.drawable.btn_body_46, R.drawable.body_46),
        Pair(R.drawable.btn_body_47, R.drawable.body_47),
        Pair(R.drawable.btn_body_48, R.drawable.body_48),
        Pair(R.drawable.btn_body_49, R.drawable.body_49),
        Pair(R.drawable.btn_body_50, R.drawable.body_50),
        Pair(R.drawable.btn_body_51, R.drawable.body_51),
        Pair(R.drawable.btn_body_52, R.drawable.body_52),
        Pair(R.drawable.btn_body_53, R.drawable.body_53),
        Pair(R.drawable.btn_body_54, R.drawable.body_54),
        Pair(R.drawable.btn_body_55, R.drawable.body_55),
        Pair(R.drawable.btn_body_56, R.drawable.body_56),
        Pair(R.drawable.btn_body_57, R.drawable.body_57),
        Pair(R.drawable.btn_body_58, R.drawable.body_58),
        Pair(R.drawable.btn_body_59, R.drawable.body_59),
        Pair(R.drawable.btn_body_60, R.drawable.body_60)
    )
